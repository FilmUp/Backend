...
/**
  * Abstract the content type being stored to create a global updatable map.
  * Log updates just to be sure things only get updated when they are supposed to.
  */
object Config {
  ...
  def setSetting(key: String, value: Any): Unit ={
